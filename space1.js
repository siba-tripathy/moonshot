...
this.spaceship.src="images/usership2.png";
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			var shipStartX = this.shipCanvas.width/2 - imageRepository.spaceship.width+24;
			var shipStartY = this.shipCanvas.height/4*3 + imageRepository.spaceship.height;
			this.ship.init(shipStartX, shipStartY, imageRepository.spaceship.width,
			               imageRepository.spaceship.height);
			//initializing enemy pool object
...
*/
	...
	*/
	...
	/* getpool returns all alive objects as an array to be inserted in quadtree*/
...
function Ship() {
	 ...
	 */
	this.fire = function() {
		this.bulletPool.getTwo(this.x+7, this.y, 3,this.x+33, this.y, 3);
		game.laser.get();
	};
}
...
//////////////////////////////////////////quadtree for divide and conqure approach for collision detection//////////
